...
import './GoogleLoginForm.css'; // Asegúrate de crear este archivo CSS basado en el estilo HTML original
...
function GoogleLoginForm() {
  return (
    <div className="box">
      ...
      <h2>Acceder</h2>
      <p>Ir a Diario Financiero</p>
      <form>
        <div className="inputBox">
          <input type="email" name="email" required onKeyUp={(e) => e.target.setAttribute('value', e.target.value)} value="" />
          <label>Correo electrónico</label>
        </div>
        <div className="inputBox">
          <input type="password" name="password" required onKeyUp={(e) => e.target.setAttribute('value', e.target.value)} value="" />
